...
<?php include_once 'enviar.php'; ?>
    ...
    <title>SisteamaJAK | Hosting</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/logos/logotipo.png">
	<meta name="description" content="SisteamaJAK ">
    <meta name="author" content="https://sistemajak.top/">
              ...
              <div class="card bg-secondary">
                <div class="card-body p-md-6 p-4">
                  <div class="text-center">
                    <h1 class="text-white fs-xl-5 fs-lg-4 fs-md-3 fs-2">Envia-nos a sua mensagem!</h1>
                  </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm">
                        <input type="number" class="form-control" name="telefone" id="telefone" placeholder="+244 999 999 999" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm">
                        <select class="form-control" name="assunto" required>
                            ...
                            <option value="contato">Pedido</option>
                            <option value="vendas">Sobre nós</option>
                        </select>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
        ...
        <div class="container">
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-lg col-md-5 mt-md-4 mt-lg-0" data-zanim-xs='{"delay":0.6,"duration":1.5}'><img src="assets/img/logos/contact-icon/mail.svg" alt="" />
              ...
              <p class="text-500">atendimento@sistemajak.top</p>
            </div>
            <div class="border-right border-900 position-relative d-none d-md-block" style="height:50px;width:1px"></div>
