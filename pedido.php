              ...
              <div class="card bg-secondary">
                <div class="card-body p-md-6 p-4">
                  <div class="text-center">
                    <h1 class="text-white fs-xl-5 fs-lg-4 fs-md-3 fs-2">Envia-nos o seu Pedido!</h1>
                  </div>
                 <form class="form-horizontal" action="pedido.php#formulario" method="post" role="form" data-toggle="validator">
                ...
                <div class="form-group">
                    <div class="col-sm">
                        <select class="form-control" name="assunto" required>
                            ...
                            <option value="contato">Site</option>
                            <option value="vendas">Hospedagem</option>
							<option value="vendas">Marketing digital</option>
                        </select>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm">
                        <textarea class="form-control" id="exampleTextarea" rows="6" 
                                  id="mensagem" name="mensagem" placeholder="Cria um codigo par o seu pedido" required></textarea>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="container">
          <div class="row text-center justify-content-center">
            <div class="col-auto">
			  ...
			  <a class="text-decoration-none font-weight-bold text-white" href="https://sistemajak.top/" target="_blank">SistemaJAK</a></p>
            </div>
          </div>
        </div>
      </section>
